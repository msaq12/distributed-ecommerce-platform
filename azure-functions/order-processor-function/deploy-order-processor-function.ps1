# ============================================
# Deploy Order Processor Function
# ============================================
# Usage: .\deploy-order-processor-function.ps1
# ============================================

param(
    [string]$FunctionAppName = "func-order-processor-dev-u5le555hps52m",
...
Write-Host "  Order Processor Function Deployment" -ForegroundColor Yellow
Write-Host "============================================" -ForegroundColor Yellow
